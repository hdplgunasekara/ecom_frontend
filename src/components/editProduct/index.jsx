...
import { getProductToEdit, getProducts } from "../../redux/productSlice";
...
export default function EditProduct() {
  ...
  const { isLoading, productForEdit } = useSelector((state) => state.product);
  const [imageUrls, setImageUrls] = React.useState(
    productForEdit.images ? productForEdit.images : []
  );
  ...
  const handleSubmit = async (event) => {
    ...
    data.append("id", productForEdit._id);
    try {
